...
// Definicja rynkow, trybow i calej logiki dopasowywania mieszka we wspolnym module, bo
// uzywa jej takze panel. Fraza oznaczona tutaj jako pokryta kategoria musi byc tak samo
// oznaczona tam — dwie kopie tej samej reguly rozjechalyby sie przy pierwszej poprawce.
export { RYNKI, budujWarianty, mamyToJuz, czesciZeSlugow, rdzen, bezOgonkow, mapujWiersz, SLOWA_PUSTE }
  from '../../netlify/wspolne/frazy-logika.mjs'
