<template>
    <section class="bg-sec-500 h-64">
      ...
      <h1 class="text-5xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                        <span class="sm:text-6xl">
                            ...
                            class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-main-500 to-main-800">RODO</span>
                        <br>
                    </h1>
                </div>
            </div>
    ...
    <article class="mx-auto container max-w-6xl mt-10">
        <p class="text-lg">Poniższa informacja stanowi zwięzły, zrozumiały i przejrzysty skrót informacji zamieszczonych
            w
            <a class="text-sunsetOrange-500" href="https://twoja-kolorowanka.pl/polityka-prywatnosci">Polityce Prywatności</a> odnośnie
        ...
        <h2 class="text-4xl py-4"><span>Jaki jest zakres przetwarzanych przez nas danych osobowych?</span></h2>
        <p class="text-lg">
            W serwisie przetwarzane są <b>dane osobowe zwykłe</b>, podane dobrowolnie przez osoby,
        ...
        <p class="text-lg">Szczegółowy zakres przetwarzanych danych dostępny jest w
            <a class="text-sunsetOrange-500" href="https://twoja-kolorowanka.pl/polityka-prywatnosci">Polityce Prywatności</a>.
        </p>
        ...
        <ul class="list-decimal text-lg py-2 pl-16">
            <li><span>Realizacji usług elektronicznych:</span>
                <ul style="list-style: lower-alpha;" class="text-lg py-2 pl-16">
                    ...
                    <li aria-level="2"><span>Usługi komentowania / polubienia wpisów w Serwisie bez konieczności
                            rejestrowania się</span></li>
                </ul>
            </li>
            <li><span>Komunikacji Administratora z Użytkownikami w sprawach związanych z Serwisem oraz ochrony
                    danych</span></li>
            <li><span>Zapewnienia prawnie uzasadnionego interesu Administratora</span></li>
        </ul>
        ...
        <ul class="list-decimal text-lg py-2 pl-16">
            <li><span>Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. w sprawie
                ...
                <ul style="list-style: lower-alpha;" class="text-lg py-2 pl-16">
                    ...
                    <li aria-level="2"><span>art. 6 ust. 1 lit. b</span><span>
                        </span><span>przetwarzanie jest niezbędne do wykonania umowy, której stroną jest osoba, której
                            dane dotyczą, lub do podjęcia działań na żądanie osoby, której dane dotyczą, przed zawarciem
                            umowy</span></li>
                    <li aria-level="2"><span>art. 6 ust. 1 lit. f</span><span>
                        </span><span>przetwarzanie jest niezbędne do celów wynikających z prawnie uzasadnionych
                            interesów realizowanych przez administratora lub przez stronę trzecią</span></li>
                </ul>
            </li>
            <li><span>Ustawa z dnia 10 maja 2018 r. o ochronie danych osobowych (Dz.U. 2018 poz. 1000)</span></li>
            <li><span>Ustawa z dnia 16 lipca 2004 r. Prawo telekomunikacyjne (Dz.U. 2004 nr 171 poz. 1800)</span></li>
        ...
        <ul class="list-decimal text-lg py-2 pl-16">
            ...
            <li><span>W celu oceny ryzyka potencjalnych klientów</span></li>
            <li><span>W celu oceny planowanych kampanii marketingowych</span></li>
        ...
        <h2 class="text-4xl py-4"><span>Kto jest odbiorcą danych w tym danych osobowych?</span></h2>
        <p class="text-lg">Co do zasady jedynym odbiorcą danych jest Administrator.</p>
        ...
        <ul class="list-decimal text-lg py-2 pl-16">
            ...
            <li><b>Prawo do usunięcia danych osobowych</b><br/><span>Użytkownikom przysługuje prawo żądania od Administratora niezwłocznego usunięcia danych
                    ...
                    umożliwiających identyfikację Użytkownika.</span><span>
                </span><span>
