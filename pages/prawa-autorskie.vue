<template>
                ...
                <div class="space-y-4">
                    ...
                    <h1 class="text-5xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                        <span class="sm:text-6xl">
                            ...
                            class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-main-500 to-main-800">autorskie</span>
                        <br>
                    </h1>
                </div>
            </div>
  ...
  <h1 class="text-4xl font-bold mb-6">Prawa autorskie</h1>

  <p>
    Serwis <strong>twoja-kolorowanka.pl</strong> powstał z pasji do wspierania edukacji, kreatywności i rozwoju dzieci. Naszą misją jest udostępnianie darmowych materiałów do druku, które pomagają rodzicom, nauczycielom i opiekunom w dostarczaniu wartościowej rozrywki oraz wspieraniu nauki poprzez zabawę.
  </p>
  ...
  <ul class="list-disc list-inside">
    <li>Imię i nazwisko lub nazwę firmy będącej właścicielem praw,</li>
    <li>Link do materiału w naszym serwisie,</li>
    <li>Dokument lub inny dowód potwierdzający przysługujące Ci prawa autorskie lub znak towarowy.</li>
  </ul>
  <p>
    Po otrzymaniu zgłoszenia natychmiast podejmiemy działania – usuniemy sporny materiał lub dodamy stosowną adnotację i oznaczenie autorstwa, jeśli będzie to wymagane.
  </p>
...
<section class="prose max-w-6xl mx-auto px-4 py-8">
  <h1 class="text-4xl font-bold mb-6">Copyright and Intellectual Property</h1>

  <p>
    The website <strong>twoja-kolorowanka.pl</strong> was created out of a passion for supporting education, creativity, and children's development. Our mission is to provide free printable materials that help parents, teachers, and caregivers offer valuable entertainment and support learning through play.
  </p>
  ...
  <ul class="list-disc list-inside">
    ...
    <li>A link to the material on our website,</li>
    <li>Proof of ownership of the copyright or trademark.</li>
  </ul>
  <p>
    Once your report is received, we will promptly take action – by removing the material or adding a proper credit or ownership notice.
  </p>
