...
## 10 ciekawostek o pierwszych kredkach malucha
<ul class="grid grid-cols-1 mb-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-3 text-center text-base md:text-lg font-light max-w-5xl mx-auto"> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-orange-500">Dwulatek trzyma kredkę całą dłonią – tzw. chwyt cylindryczny jest w pełni prawidłowy na tym etapie.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-tertiary-400">Pierwsze bazgroły to ważny etap rozwoju – tak dłoń uczy się ruchów potrzebnych później do pisania.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-yellow-500">Maluchy rysują najpierw ruchem całego ramienia, dopiero potem nadgarstka i palców.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-sec-500">Grube kredki świecowe prowadzi się lżej niż ołówkowe – idealne na start.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-main-500">Dwulatek skupia się na jednej czynności średnio 3–6 minut – krótkie sesje to norma.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-coolGray-500">Kolory podstawowe – czerwony, żółty i niebieski – maluchy rozpoznają najwcześniej.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-orange-500">Wspólne kolorowanie z rodzicem buduje więź skuteczniej niż niejedna zabawka.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-tertiary-400">Chwalenie procesu działa lepiej niż ocenianie efektu.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-yellow-500">Kolorowanie wycisza także maluchy – sprawdza się przed drzemką.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-sec-500">Każdy bazgroł to opowieść – zapytaj malucha, co narysował.</li> </ul>
## Drukuj bez limitu
