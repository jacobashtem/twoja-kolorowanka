...
## 10 ciekawostek o motylach
<ul class="grid grid-cols-1 mb-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-3 text-center text-base md:text-lg font-light max-w-5xl mx-auto"> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-orange-500">Skrzydła motyla są przezroczyste – kolory to gra światła na mikroskopijnych łuskach.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-tertiary-400">Na świecie żyje około 20 000 gatunków motyli – paleta inspiracji bez dna.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-yellow-500">Motyl monarcha przelatuje podczas migracji nawet 4000 kilometrów.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-sec-500">Symetria skrzydeł to naturalne ćwiczenie z lustrzanego kolorowania.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-main-500">Motyle widzą ultrafiolet – kolory, których człowiek nie umie sobie wyobrazić.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-coolGray-500">Jedenastolatki tworzą już własne palety zamiast kopiować naturę – i słusznie.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-orange-500">Najciekawsze efekty daje łączenie cienkopisów z kredkami akwarelowymi.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-tertiary-400">Motyl żyje średnio 2–4 tygodnie – jego portret na papierze zostaje na lata.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-yellow-500">Misterne wzory skrzydeł to już poziom antystresowy – godzina relaksu gwarantowana.</li> <li class="bg-none text-black p-2 flex items-center justify-center font-medium rounded border-4 border-dotted border-sec-500">W wielu kulturach motyl symbolizuje przemianę – piękny motyw na progu nastoletniości.</li> </ul>
